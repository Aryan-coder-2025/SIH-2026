...
FEATURE_DISPLAY_MAP: Dict[str, Dict[str, str]] = {
    ...
    "bytes_std": {
        "display_name": "Payload Byte Variance",
        "up_desc": "High variability in byte transmission sizes",
        "down_desc": "Uniform byte transmission sizes",
    },
    "packets_mean": {
        "display_name": "Mean Packet Count",
        "up_desc": "High average packet density per flow",
        "down_desc": "Low average packet density",
    },
    "duration_std": {
        "display_name": "Flow Duration Variance",
        "up_desc": "High variance in connection lifespans",
        "down_desc": "Uniform connection lifespans",
    },
    "iat_max": {
        "display_name": "Maximum Inter-Arrival Time",
        "up_desc": "Extended silence intervals between bursts",
        "down_desc": "Continuous packet arrival stream",
    },
    "tcp_flow_ratio": {
        "display_name": "TCP Traffic Ratio",
        "up_desc": "Dominance of stateful TCP protocol sessions",
        "down_desc": "Low proportion of TCP traffic",
    },
    "udp_flow_ratio": {
        "display_name": "UDP Traffic Ratio",
        "up_desc": "Elevated stateless UDP flood or probe activity",
        "down_desc": "Low proportion of UDP traffic",
    },
    "fin_count": {
        "display_name": "TCP FIN Count",
        "up_desc": "Rapid session termination bursts",
        "down_desc": "Normal session teardown rate",
    },
    "rst_count": {
        "display_name": "TCP RST Count",
        "up_desc": "Frequent abnormal connection terminations",
        "down_desc": "Clean connection teardowns",
    },
    "psh_count": {
        "display_name": "TCP PSH Count",
        "up_desc": "Urgent application data transmission push",
        "down_desc": "Low push frequency",
    },
    "urg_count": {
        "display_name": "TCP URG Count",
        "up_desc": "Out-of-band urgent pointer signaling",
        "down_desc": "No urgent pointer flags",
    },
    "ttl_min": {
        "display_name": "Minimum TTL",
        "up_desc": "Anomalous low-hop routing path",
        "down_desc": "Standard minimum hop count",
    },
    "ttl_max": {
        "display_name": "Maximum TTL",
        "up_desc": "Long-distance or spoofed hop count",
        "down_desc": "Standard maximum hop count",
    },
    "payload_mean": {
        "display_name": "Mean Packet Payload",
        "up_desc": "High average payload volume per packet",
        "down_desc": "Header-only or minimal packet payload",
    },
    "payload_std": {
        "display_name": "Payload Size Variance",
        "up_desc": "Irregular payload sizes across packets",
        "down_desc": "Fixed-size packet transfers",
    },
    "payload_min": {
        "display_name": "Minimum Payload Size",
        "up_desc": "Non-zero minimum data frames",
        "down_desc": "Zero-length control packets present",
    },
    "payload_max": {
        "display_name": "Maximum Payload Size",
        "up_desc": "Maximum transmission unit (MTU) burst",
        "down_desc": "Small maximum packet sizes",
    },
    "port_scan_score": {
        "display_name": "Port Scan Heuristic Score",
        "up_desc": "High heuristic multi-port reconnaissance indicator",
        "down_desc": "Nominal single-service traffic pattern",
    },
    "packet_iat_mean": {
        "display_name": "Mean Packet IAT",
        "up_desc": "Prolonged inter-packet intervals",
        "down_desc": "High-frequency packet bursts",
    },
    "packet_iat_max": {
        "display_name": "Max Packet IAT",
        "up_desc": "Longest inter-packet delay observed",
        "down_desc": "Continuous uninterrupted stream",
    },
}
...
class AttributionExplainer:
    """
    Feature Attribution Translation & Multi-Horizon Explanation Engine.

    CONTRACT & HONEST ATTRIBUTION SPECIFICATION:
    This explainer is an attribution consumer and SOC translation layer. It accepts
    continuous feature attribution matrices/tensors (such as those generated by
    Gradient SHAP, Kernel SHAP, Integrated Gradients, or DeepLIFT) across discrete
    forecast horizons (+10s, +20s, +30s) and historical windows (0..T-1), and translates
    them into ranked, human-interpretable SOC explanations and urgency ratings.
    It separates raw model risk scores from attribution magnitudes.
    """
